...
Project _projectDeserialize(
  ...
  final object = Project(
    color: reader.readStringOrNull(offsets[0]) ?? 'blue',
    createdAt: reader.readDateTimeOrNull(offsets[1]),
    description: reader.readStringOrNull(offsets[2]),
    icon: reader.readLongOrNull(offsets[3]),
...
P _projectDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? 'blue') as P;
    case 1:
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> iconIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'icon',
      ));
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> iconIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'icon',
      ));
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, String, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, int?, QQueryOperations> iconProperty() {
    return QueryBuilder.apply(this, (query) {
